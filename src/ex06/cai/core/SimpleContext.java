...
public class SimpleContext implements Context, Pipeline, Lifecycle {
	...
	public Container[] findChildren() {
		synchronized (children) {
			...
			children.values().toArray(results);
			return results;
		}
	}
	...
	public void start() throws LifecycleException {
		...
		// Notify our interested LifecycleLinsteners
		lifecycle.fireLifecycleEvent(Lifecycle.BEFORE_START_EVENT, null);
		started = true;
		try{
			// start subordinate components, if any
			if(loader != null && loader instanceof Lifecycle){
				((Lifecycle)loader).start();
			}
			// start our child container, if any
			...
			// start the Valves in pipeline(including the basic),if any
			// valve没有start方法
